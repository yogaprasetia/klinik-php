<?php
	  include("koneksi.php");
	  $id=$_GET['id'];
	  $query=mysqli_query($config,"select * from pasien where id='$id'");
                ...
                <div class="card" align="center">
                    <div class="row">
                        <div class="col">
                            <table class="table">
                                <tr>
                                    <th width="20%">Nomor ID. Rekam Medis</th>
                                    <td>:</td>
                                ...
                                <tr>
                                    <th>Tgl Daftar</th>
                                    <td>:</td>
                                    <td><?php echo $ambil_data['tgl_daftar']; ?></td>
                                </tr>
                                <tr>
                                    <th>Tgl Janji</th>
                                    <td>:</td>
                                    <td><?php echo $ambil_data['tgl_janji']; ?></td>
                                </tr>
                            </table>
                        </div>
                    </div>
